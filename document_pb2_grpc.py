...
class DocumentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DownloadDocument = channel.unary_stream(
                ...
                response_deserializer=document__pb2.DocumentChunk.FromString,
                _registered_method=True)
...
def add_DocumentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DownloadDocument': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=document__pb2.DocumentChunk.SerializeToString,
            ),
    }
...
class DocumentService(object):
    ...
    def DownloadDocument(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            document__pb2.DocumentChunk.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
